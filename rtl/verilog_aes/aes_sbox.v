// =============================================================================
// aes_sbox.v
// AES Forward S-box (SubBytes transformation)
//
// Implements the full AES S-box lookup table per FIPS-197, Table 4.
// Input  : 8-bit value 'a'
// Output : 8-bit substituted value 'd'
//
// This is purely combinational logic (case statement) and is synthesizable.
// =============================================================================
...
module aes_sbox (
    ...
    // Combinational S-box lookup (FIPS-197, Section 5.1.1, Table 4)
    // S-box maps each byte value 0x00..0xFF to a substituted byte.
    reg [7:0] s;
